...
It uses [Quartz](https://github.com/jackyzha0/quartz) to build the site, and alters the Quartz config on on the fly so that
a single Quartz installation can be used to publish any number of sites.

Have a look at the [Task Zero docs](https://taskzero.alan.gr) if you want to see an example of the output.
